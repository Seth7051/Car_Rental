...
public class InputDBSQLEmployees
{
		 ...
		 */
		public static boolean LoadListFromDatabase( String strTable, String strPrimaryKeyColumn, String strLocationColumn, String strAddress, String strCity, String strState, String strZip ) {
			...
			try
			{
				...
				strSelect = "SELECT " + strPrimaryKeyColumn + ", " + strLocationColumn + ", " + strAddress + ", " + strCity + ", " + strState + ", " + strZip
							+ " FROM " + strTable; 
				...
				while( rstTSource.next( ) == true )
				{
					...
					strLocationColumn = rstTSource.getString( 2 );
					...
					// Print the list
					System.out.println("ID: " + intID + "	Location: " + strLocationColumn + "	Address: " + strAddress + "	City: " + strCity + "	State: " + strState );
					System.out.println("Zip: " + strZip);
				}
				// Clean up
				rstTSource.close( );
				sqlCommand.close( );
			...
			try
			{
				...
				// Login Type:
					...
					// SQL Server
					 ...
					 sdsTeamsAndPlayers.setPassword( "RandomPassword123!" );	// Empty string "" for blank password
